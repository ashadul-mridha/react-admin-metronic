						...
						<div className="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div className="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
								...
								<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
									...
									<div className="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/pricing/pricing-1.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/pricing/pricing-2.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
								...
								<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
									...
									<div className="menu-sub menu-sub-accordion menu-active-bg">
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/basic/sign-in.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/basic/sign-up.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/basic/two-steps.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/basic/password-reset.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/basic/new-password.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/aside/sign-in.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Sign-in</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/aside/sign-up.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Sign-up</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/aside/two-steps.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Two-steps</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/aside/password-reset.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Password Reset</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/aside/new-password.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">New Password</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/dark/sign-in.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Sign-in</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/dark/sign-up.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Sign-up</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/dark/two-steps.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Two-steps</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/dark/password-reset.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Password Reset</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/layouts/dark/new-password.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">New Password</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/authentication/extended/two-factor-authentication.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/authentication/extended/free-trial-sign-up.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/authentication/extended/coming-soon.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/authentication/general/deactivation.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/email/verify-email.html" target="blank">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Verify Email</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/email/invitation.html" target="blank">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/email/password-reset.html" target="blank">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Password Reset</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/authentication/email/password-change.html" target="blank">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
								...
								<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
									...
									<div className="menu-sub menu-sub-accordion menu-active-bg">
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-1.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-2.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-3.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-4.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-5.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/layouts/toolbars/no-toolbar.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
								...
								<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
									...
									<div className="menu-sub menu-sub-accordion menu-active-bg">
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/layouts/aside/light.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/layouts/aside/font-icons.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/layouts/aside/minimized.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											<a className="menu-link" href="../../demo1/dist/layouts/aside/only-header.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
								...
								<div className="menu-item">
									<a className="menu-link" href="https://preview.keenthemes.com/metronic8/demo1/layout-builder.html" title="Build your layout and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span className="menu-icon">
								...
								<div className="menu-item">
									<a className="menu-link" href="../../demo1/dist/documentation/getting-started/changelog.html">
										...
										<span className="menu-title">Changelog v8.0.36</span>
									</a>
								</div>
							</div>
							{/* <!--end::Menu--> */}
